...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.carmowallison.maisvida.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Mais Vida",
				"Esta API é do desafio da Mais Vida.", "Versão 1.0",
				"https://github.com/wallisoncarmo/maisvida_backend",
				new Contact("Wallison do Carmo Costa", "https://github.com/wallisoncarmo/maisvida_backend", "wallisoncarmo01@gmail.com"),
				null, 
